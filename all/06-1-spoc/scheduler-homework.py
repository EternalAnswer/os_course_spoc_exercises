...
parser.add_option("-q", "--quantum", help="length of time slice for RR and MLFQ policy", default=1, 
                  action="store", type="int", dest="quantum")
parser.add_option("-n", "--queuenum", help="number of queues in MLFQ", default=3,
                  action="store", type="int", dest="queuenum")
